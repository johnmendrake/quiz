...
public class Auswahl extends JFrame {
    ...
    private JTextArea textSpieler = new JTextArea("");
      private JScrollPane textSpielerScrollPane = new JScrollPane(textSpieler);
    // Ende Attribute
    
    public Auswahl(Quiz1 pMeinQuiz1 ,ArrayList<Player> pPlayers) { 
